<!-- ===== frontend/src/projects/bmi/components/BMICalculator.vue ===== -->
<template>
  <div class="bmi-calculator">
    ...
    <bmi-result v-if="result" :result="result" />
  </div>
</template>
...
import type { BMIFormData, BMIResult } from '../types';

const formRef = ref<FormInstance>();
const bmiStore = useBMIStore();
const { lastInput, isLoading, loadLastInput, calculate } = bmiStore;
